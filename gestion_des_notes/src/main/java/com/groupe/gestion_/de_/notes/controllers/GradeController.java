...
@CrossOrigin(origins = "http://localhost:4300") // Adjust for your React app's URL
public class GradeController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "Forbidden: Only Admins and Teachers can view all grades")
    })
    @GetMapping
