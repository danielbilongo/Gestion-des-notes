    ...
    private GradeResponse mapGradeToResponse(Grade grade) {
        ...
        if (grade.getSubject() != null) {
            subjectResponse = SubjectResponse.builder()
                    ...
                    .semester(grade.getSubject().getSemester())  // ✅ AJOUT DU SEMESTRE !
                    .build();
        }
        ...
        return GradeResponse.builder()
                ...
                .studentIdNum(studentResponse != null ? studentResponse.getStudentIdNum() : null)
                .firstname(studentResponse != null ? studentResponse.getFirstname() : null)
                .lastname(studentResponse != null ? studentResponse.getLastname() : null)
                .subjectCode(subjectResponse != null ? subjectResponse.getSubjectCode() : null)
                .subjectName(subjectResponse != null ? subjectResponse.getName() : null)
                .semester(subjectResponse != null ? subjectResponse.getSemester() : null)
                .recordedBy(recordedByTeacherResponse != null ? recordedByTeacherResponse.getTeacherIdNum() : null)
                .build();
    }
}
